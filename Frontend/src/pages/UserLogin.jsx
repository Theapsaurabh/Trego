...
const UserLogin = () => {
  ...
  return (
    ...
    <p className='text-center'>new here ? <Link to="/user-signup" className='text-blue-600'>Create a new Account</Link></p>
      </form>
     ...
     <div>
      ...
      <Link to="/captain-login"  className='bg-[rgb(210,17,17)] flex items-center justify-center text-white font-medium mb-7 rounded px-4 py-2   w-full text-lg placeholder:text-base'>
